...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/complaint/ACT_Compliant-management-system/Admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
